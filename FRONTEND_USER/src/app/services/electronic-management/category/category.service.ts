...
export class CategoryService {
  ...
  getListComboboxNoParent(): Observable<any> {
    return this.http.get(environment.BASE_API_URL + categoryRouter.getListComboboxNoParent + environment.ALLOW_ANONYMOUS);
  }
}
